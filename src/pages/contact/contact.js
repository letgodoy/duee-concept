        ...
        {/* <section id="contato"> */}
            <div className="row background middle-xs" id="contato">
                ...
                <div className="col-xs-12 row center-xs" style={{ alignSelf: 'stretch' }}>
                    ...
                    <div className="col-md-2 col-xs-12 col-sm-6 phone slideUp middle-xs">
                        <i className="fas fa-phone hatch"></i>
                        <h4>Telefone</h4>
                        <p>11 2532.7152</p>
                    </div>
                    <div className="col-md-3 col-xs-12 col-sm-6 mail slideUp middle-xs">
                    ...
                    <div className="col-md-4 col-xs-12 col-sm-6 middle-xs">
