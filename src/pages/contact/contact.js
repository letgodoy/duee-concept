        ...
        <section id="contato">
            <div className="row background">
                ...
                <div className="col-xs-12 row center-xs" style={{ alignSelf: 'stretch' }}>
                    <div className="col-md-3 col-xs-12 local slideUp middle-xs">
                        <i className="fas fa-map-marker-alt hatch"></i>
                        <h4>São Paulo</h4>
                        <p>Alameda Joaquim Eugênio de Lima, 696 - Jardins</p>
                        <p>CEP 01403-000</p>
                    </div>
                    <div className="col-md-2 col-xs-12 phone slideUp middle-xs">
                        <i className="fas fa-phone hatch"></i>
                        <h4>Telefone</h4>
                        <p>11 2532.7152</p>
                    </div>
                    <div className="col-md-3 col-xs-12 mail slideUp middle-xs">
                    ...
                    <div className="col-md-4 col-sm-12 middle-xs">
