    ...
    render() {
        return (
            <Layout>
                ...
                <iframe src="https://player.vimeo.com/video/355173390" className="video" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                ...
                <div className="row end-xs middle-xs" id="versinho">
                    <div className="text slideDown col-xs-12 col-md-5 col-sm-6">
                        <h3>SOMOS LEÕES</h3>
                    ...
                    <div className="col-xs-12 col-md-7 col-sm-6 slideLeft">
                ...
                <div id='news' className="row" >
                    ...
                    <div className="col-xs-12 row vermais center-xs">
                        <Collapse isOpened={this.state.openNews}>
                            ...
                            <div className="col-xs-12 row midia">
                                <h4>Duee na midia</h4>
